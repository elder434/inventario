                    ...
                    <div class="row">
                        <div class="col-xl-9">
                            <div class="invoice-content">
                                <form action="{{route('temporal.update', $tipos)}}" method="POST" class="formulario-editar" enctype="multipart/form-data">
                                    @method('put')
                                    @csrf
                                    <div class="invoice-detail-body">
                                        <div class="invoice-detail-header">
                                            ...
                                            <div class="form-row mb-4">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select name="responsable" class="form-control ">
                                                        ...
                                                        @if ($responsables->responsable == $tipos->responsableT)
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label>ESTADO</label>
                                                    <input type="text" class="form-control form-control-sm" placeholder="estado" name="estado" value="{{old('estado',$tipos->estadoT)}}" required>
                                                    @error('estado')
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <input type="text" class="form-control" placeholder="Observacion" name="observacion" value="{{old('observacion',$tipos->observacionT)}}">
                                            </div>
                                            <!-- fin de creaccion -->
                                        </div>   
                                    </div>
                                    ...
                                    <div class="invoice-action-btn">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-12 col-md-6 mt-2">
                                                <a href="{{route('temporal.index')}}" class="btn btn-dark btn-block btn-edit ">Volver</a>
                                            </div>
                                        </div>
                                    </div> 
                                </form>
